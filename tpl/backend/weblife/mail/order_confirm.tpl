        ...
        <div class="page" style="margin:0 auto; padding:0; text-align:left; width:210mm" align="left" width="210mm">
            <div class="print-page" style="padding:3.5em 5em">
                ...
                <div class="print-order">
                    <h2 class="print-order-title" style="margin-bottom:1em; margin-top:0; font-size:2em; font-weight:400">Подтверждение заказа № <{$arData.oid}>!</h2>
                    <p style="font-size: 1.5em;"><{if !empty($arData.firstname)}>Здравствуйте, <{$arData.firstname}>!<br/><{/if}>
