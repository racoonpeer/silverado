...
<?php if (!$_smarty_tpl->tpl_vars['list']->value){?>
        <a href="#" onclick="return Modal.open('<?php echo $_smarty_tpl->getSubTemplate ("core/href.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, null, null, array('arCategory'=>$_smarty_tpl->tpl_vars['arrModules']->value['quickcheckout'],'params'=>("itemID=").($_smarty_tpl->tpl_vars['item']->value['id'])), 0);?>
');" class="buy-quick"> упить в 1 клик</a>
    </div>
<?php }?>
</div><?php }} ?>