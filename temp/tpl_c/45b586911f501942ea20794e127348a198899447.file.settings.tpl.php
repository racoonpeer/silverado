<?php /* Smarty version Smarty-3.1.14, created on 2017-11-14 21:30:46
         compiled from "tpl/backend/weblife/module/settings.tpl" */ ?>
<?php /*%%SmartyHeaderCode:6486741875a0b4466e23d13-80698642%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '6486741875a0b4466e23d13-80698642',
  'function' => 
  array (
  ),
  'variables' => 
    ...
    function updateHistory(item, refresh, page) { 
        ...
        $.ajax({
            ...
            success: function(json) {
                ...
                if(History.enabled) {
                    History.pushState(null, document.title, '/admin/?module=<?php echo $_smarty_tpl->tpl_vars['arrPageData']->value['module'];?>
'+json.url);
                }
            }
        });
