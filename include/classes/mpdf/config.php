...
$this->bleedMargin = 0;
$this->crossMarkMargin = 0;		// Distance of cross mark from margin in mm
$this->cropMarkMargin = 0;		// Distance of crop mark from margin in mm
$this->cropMarkLength = 0;		// Default length in mm of crop line
$this->nonPrintMargin = 5;		// Non-printable border at edge of paper sheet in mm
//	mPDF 5.5
...
$this->default_lineheight_correction = 1.4;	// Value 1 sets lineheight=fontsize height; 
