...
<{if isset($shortcut) && $shortcut}>
    <div class="addNew" style="width:auto; padding-right:5px">
        <a <{if isset($shortcut) && $shortcut}>style="padding-right:5px;"<{/if}> href="/admin/?module=shortcuts<{if isset($arrPageData.cid) && $arrPageData.cid>0}>&cid=<{$arrPageData.cid}><{/if}>&task=addItem&object_module=<{$arrPageData.module}>">ÿנכûך</a>
    </div>
<{/if}>