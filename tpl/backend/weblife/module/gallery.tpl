...
<{include file='common/module_head.tpl' 
          title=$smarty.const.GALLERY 
          creat_title=$smarty.const.ADMIN_CREATING_NEW_IMAGE 
          edit_title=$smarty.const.ADMIN_EDIT_IMAGE 
}>
...
<{* +++++++++++++++++++++++++ SHOW ALL ITEMS ++++++++++++++++++++++++++ *}>
<{else}>
<{include file='common/new_page_btn.tpl' title=$smarty.const.ADMIN_ADD_NEW_IMAGE}>
